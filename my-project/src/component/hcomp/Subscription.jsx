  ...
  return (
   ...
   <div className='h-[100%] w-[100%] md:w-[100%] md:h-[100%] '>
    <div className='bg-center min-h-screen' style={subscriptionStyle}>
        ...
        < Button className= "text-[#fff] text-[1rem] flex gap-[0.5rem] items-center bg-[#3333F5] px-6 py-3 rounded-full relative top-[20rem] left-[26rem]" content = "DISCOVER NURANOW"/>
    </div>
   </div>
   </>
  )
