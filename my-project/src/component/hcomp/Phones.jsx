...
const Phones = () => {
  return (
    <>
<section className='w-[100%] h-[100%] md:w-[100%] md:h-[100%]'>   
...
<div className='relative top-[8rem]'>
    ...
    <Button content = "LEARN MORE" className="flex items-center gap-[5px] text-white border border-white px-3 py-2 mt-4 rounded-full"/>
</div>
</div>
</section>
    </>
